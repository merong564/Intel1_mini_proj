...
class YoloCarNavGoal(Node):
    def __init__(self):
        ...
        # ROS 2 subscriptions
        self.create_subscription(CameraInfo, '/robot1/oakd/rgb/camera_info', self.camera_info_callback, 10)
        self.create_subscription(Image, '/robot1/oakd/rgb/image_raw', self.rgb_callback, 10)
        self.create_subscription(Image, '/robot1/oakd/stereo/image_raw', self.depth_callback, 10)
...
# It subscribes to RGB and depth images, processes them to find people, calculates their 3D positions, and sends navigation goals to the detected car's location in the map frame.
